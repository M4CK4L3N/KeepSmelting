...
extends BlockIronFurnaceContainerBase {
    public BlockUnobtainiumFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super((MenuType)Registration.UNOBTAINIUM_FURNACE_CONTAINER.get(), windowId, world, pos, playerInventory, player);
        this.te = (BlockUnobtainiumFurnaceTile)world.m_7702_(pos);
    }
}
