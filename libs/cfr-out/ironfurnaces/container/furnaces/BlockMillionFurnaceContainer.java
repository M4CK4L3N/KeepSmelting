...
public class BlockMillionFurnaceContainer
extends BlockIronFurnaceContainerBase {
    public BlockMillionFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super((MenuType)Registration.MILLION_FURNACE_CONTAINER.get(), windowId, world, pos, playerInventory, player);
        this.te = (BlockMillionFurnaceTile)world.m_7702_(pos);
    }
}
